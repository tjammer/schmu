...
Test x86_64-linux-gnu ABI (parts of it, anyway)
  ...
  declare { i64, i32 } @subi3({ i64, i32 } %0)
  ...
  entry:
    %0 = alloca %v2, align 8
    %z58 = bitcast %v2* %0 to float*
    store float 1.000000e+00, float* %z58, align 4
    ...
    %2 = alloca %i2, align 8
    %x59 = bitcast %i2* %2 to i32*
    store i32 1, i32* %x59, align 4
    ...
    %4 = alloca %v1, align 8
    %z960 = bitcast %v1* %4 to float*
    store float 1.000000e+00, float* %z960, align 4
    ...
    %6 = alloca %i1, align 8
    %x1561 = bitcast %i1* %6 to i32*
    store i32 1, i32* %x1561, align 4
    %ret18 = alloca %i1, align 8
    %7 = tail call i32 @subi1(i32 1)
    %box19 = bitcast %i1* %ret18 to i32*
    store i32 %7, i32* %box19, align 4
    %8 = alloca %v3, align 8
    %x2162 = bitcast %v3* %8 to float*
    store float 1.000000e+00, float* %x2162, align 4
    ...
    %w63 = bitcast %i3* %10 to i32*
    store i32 1, i32* %w63, align 4
    ...
    %unbox31 = bitcast %i3* %10 to { i64, i32 }*
    %unbox32 = load { i64, i32 }, { i64, i32 }* %unbox31, align 4
    %ret33 = alloca %i3, align 8
    %11 = tail call { i64, i32 } @subi3({ i64, i32 } %unbox32)
    %box34 = bitcast %i3* %ret33 to { i64, i32 }*
    store { i64, i32 } %11, { i64, i32 }* %box34, align 4
    %12 = alloca %v4, align 8
    %x3664 = bitcast %v4* %12 to float*
    store float 1.000000e+00, float* %x3664, align 4
    %y37 = getelementptr inbounds %v4, %v4* %12, i32 0, i32 1
    store float 1.000000e+01, float* %y37, align 4
    %z38 = getelementptr inbounds %v4, %v4* %12, i32 0, i32 2
    store float 1.000000e+02, float* %z38, align 4
    %w39 = getelementptr inbounds %v4, %v4* %12, i32 0, i32 3
    store float 1.000000e+03, float* %w39, align 4
    %unbox40 = bitcast %v4* %12 to { <2 x float>, <2 x float> }*
    %unbox41 = load { <2 x float>, <2 x float> }, { <2 x float>, <2 x float> }* %unbox40, align 8
    %ret42 = alloca %v4, align 8
    %13 = tail call { <2 x float>, <2 x float> } @subv4({ <2 x float>, <2 x float> } %unbox41)
    %box43 = bitcast %v4* %ret42 to { <2 x float>, <2 x float> }*
    store { <2 x float>, <2 x float> } %13, { <2 x float>, <2 x float> }* %box43, align 8
    %14 = alloca %mixed4, align 8
    %x4565 = bitcast %mixed4* %14 to float*
    store float 1.000000e+00, float* %x4565, align 4
    %y46 = getelementptr inbounds %mixed4, %mixed4* %14, i32 0, i32 1
    store float 1.000000e+01, float* %y46, align 4
    %z47 = getelementptr inbounds %mixed4, %mixed4* %14, i32 0, i32 2
    store float 1.000000e+02, float* %z47, align 4
    %k = getelementptr inbounds %mixed4, %mixed4* %14, i32 0, i32 3
    store i32 1, i32* %k, align 4
    %unbox48 = bitcast %mixed4* %14 to { <2 x float>, i64 }*
    %unbox49 = load { <2 x float>, i64 }, { <2 x float>, i64 }* %unbox48, align 8
    %ret50 = alloca %mixed4, align 8
    %15 = tail call { <2 x float>, i64 } @submixed4({ <2 x float>, i64 } %unbox49)
    %box51 = bitcast %mixed4* %ret50 to { <2 x float>, i64 }*
    store { <2 x float>, i64 } %15, { <2 x float>, i64 }* %box51, align 8
    %16 = alloca %trailv2, align 8
    %a66 = bitcast %trailv2* %16 to i32*
    store i32 1, i32* %a66, align 4
    ...
    %unbox53 = bitcast %trailv2* %16 to { i64, <2 x float> }*
    %unbox54 = load { i64, <2 x float> }, { i64, <2 x float> }* %unbox53, align 8
    %ret55 = alloca %trailv2, align 8
    %17 = tail call { i64, <2 x float> } @subtrailv2({ i64, <2 x float> } %unbox54)
    %box56 = bitcast %trailv2* %ret55 to { i64, <2 x float> }*
    store { i64, <2 x float> } %17, { i64, <2 x float> }* %box56, align 8
    ret i32 0
  }
