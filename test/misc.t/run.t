...
Test x86_64-linux-gnu ABI (parts of it, anyway)
  ...
  declare { <2 x float>, float } @subv3(<2 x float> %0, float %1)
  
  declare { i64, i32 } @subi3(i64 %0, i32 %1)
  
  declare { <2 x float>, <2 x float> } @subv4(<2 x float> %0, <2 x float> %1)
  
  declare { <2 x float>, i64 } @submixed4(<2 x float> %0, i64 %1)
  
  declare { i64, <2 x float> } @subtrailv2(i64 %0, <2 x float> %1)
  
  define i32 @main(i32 %arg) {
  entry:
    %0 = alloca %v2, align 8
    %z71 = bitcast %v2* %0 to float*
    store float 1.000000e+00, float* %z71, align 4
    ...
    %2 = alloca %i2, align 8
    %x72 = bitcast %i2* %2 to i32*
    store i32 1, i32* %x72, align 4
    ...
    %4 = alloca %v1, align 8
    %z973 = bitcast %v1* %4 to float*
    store float 1.000000e+00, float* %z973, align 4
    ...
    %6 = alloca %i1, align 8
    %x1574 = bitcast %i1* %6 to i32*
    store i32 1, i32* %x1574, align 4
    %ret18 = alloca %i1, align 8
    %7 = tail call i32 @subi1(i32 1)
    %box19 = bitcast %i1* %ret18 to i32*
    store i32 %7, i32* %box19, align 4
    %8 = alloca %v3, align 8
    %x2175 = bitcast %v3* %8 to float*
    store float 1.000000e+00, float* %x2175, align 4
    ...
    %fst76 = bitcast { <2 x float>, float }* %unbox24 to <2 x float>*
    %fst25 = load <2 x float>, <2 x float>* %fst76, align 8
    %snd = getelementptr inbounds { <2 x float>, float }, { <2 x float>, float }* %unbox24, i32 0, i32 1
    %ret27 = alloca %v3, align 8
    %9 = tail call { <2 x float>, float } @subv3(<2 x float> %fst25, float 1.000000e+02)
    %box28 = bitcast %v3* %ret27 to { <2 x float>, float }*
    store { <2 x float>, float } %9, { <2 x float>, float }* %box28, align 8
    %10 = alloca %i3, align 8
    %w77 = bitcast %i3* %10 to i32*
    store i32 1, i32* %w77, align 4
    %y30 = getelementptr inbounds %i3, %i3* %10, i32 0, i32 1
    store i32 10, i32* %y30, align 4
    %z31 = getelementptr inbounds %i3, %i3* %10, i32 0, i32 2
    store i32 100, i32* %z31, align 4
    %unbox32 = bitcast %i3* %10 to { i64, i32 }*
    %fst3378 = bitcast { i64, i32 }* %unbox32 to i64*
    %fst34 = load i64, i64* %fst3378, align 4
    %snd35 = getelementptr inbounds { i64, i32 }, { i64, i32 }* %unbox32, i32 0, i32 1
    %ret37 = alloca %i3, align 8
    %11 = tail call { i64, i32 } @subi3(i64 %fst34, i32 100)
    %box38 = bitcast %i3* %ret37 to { i64, i32 }*
    store { i64, i32 } %11, { i64, i32 }* %box38, align 4
    %12 = alloca %v4, align 8
    %x4079 = bitcast %v4* %12 to float*
    store float 1.000000e+00, float* %x4079, align 4
    %y41 = getelementptr inbounds %v4, %v4* %12, i32 0, i32 1
    store float 1.000000e+01, float* %y41, align 4
    %z42 = getelementptr inbounds %v4, %v4* %12, i32 0, i32 2
    store float 1.000000e+02, float* %z42, align 4
    %w43 = getelementptr inbounds %v4, %v4* %12, i32 0, i32 3
    store float 1.000000e+03, float* %w43, align 4
    %unbox44 = bitcast %v4* %12 to { <2 x float>, <2 x float> }*
    %fst4580 = bitcast { <2 x float>, <2 x float> }* %unbox44 to <2 x float>*
    %fst46 = load <2 x float>, <2 x float>* %fst4580, align 8
    %snd47 = getelementptr inbounds { <2 x float>, <2 x float> }, { <2 x float>, <2 x float> }* %unbox44, i32 0, i32 1
    %snd48 = load <2 x float>, <2 x float>* %snd47, align 8
    %ret49 = alloca %v4, align 8
    %13 = tail call { <2 x float>, <2 x float> } @subv4(<2 x float> %fst46, <2 x float> %snd48)
    %box50 = bitcast %v4* %ret49 to { <2 x float>, <2 x float> }*
    store { <2 x float>, <2 x float> } %13, { <2 x float>, <2 x float> }* %box50, align 8
    %14 = alloca %mixed4, align 8
    %x5281 = bitcast %mixed4* %14 to float*
    store float 1.000000e+00, float* %x5281, align 4
    %y53 = getelementptr inbounds %mixed4, %mixed4* %14, i32 0, i32 1
    store float 1.000000e+01, float* %y53, align 4
    %z54 = getelementptr inbounds %mixed4, %mixed4* %14, i32 0, i32 2
    store float 1.000000e+02, float* %z54, align 4
    %k = getelementptr inbounds %mixed4, %mixed4* %14, i32 0, i32 3
    store i32 1, i32* %k, align 4
    %unbox55 = bitcast %mixed4* %14 to { <2 x float>, i64 }*
    %fst5682 = bitcast { <2 x float>, i64 }* %unbox55 to <2 x float>*
    %fst57 = load <2 x float>, <2 x float>* %fst5682, align 8
    %snd58 = getelementptr inbounds { <2 x float>, i64 }, { <2 x float>, i64 }* %unbox55, i32 0, i32 1
    %snd59 = load i64, i64* %snd58, align 4
    %ret60 = alloca %mixed4, align 8
    %15 = tail call { <2 x float>, i64 } @submixed4(<2 x float> %fst57, i64 %snd59)
    %box61 = bitcast %mixed4* %ret60 to { <2 x float>, i64 }*
    store { <2 x float>, i64 } %15, { <2 x float>, i64 }* %box61, align 8
    %16 = alloca %trailv2, align 8
    %a83 = bitcast %trailv2* %16 to i32*
    store i32 1, i32* %a83, align 4
    %b = getelementptr inbounds %trailv2, %trailv2* %16, i32 0, i32 1
    store i32 2, i32* %b, align 4
    %c = getelementptr inbounds %trailv2, %trailv2* %16, i32 0, i32 2
    store float 1.000000e+00, float* %c, align 4
    %d = getelementptr inbounds %trailv2, %trailv2* %16, i32 0, i32 3
    store float 2.000000e+00, float* %d, align 4
    %unbox63 = bitcast %trailv2* %16 to { i64, <2 x float> }*
    %fst6484 = bitcast { i64, <2 x float> }* %unbox63 to i64*
    %fst65 = load i64, i64* %fst6484, align 4
    %snd66 = getelementptr inbounds { i64, <2 x float> }, { i64, <2 x float> }* %unbox63, i32 0, i32 1
    %snd67 = load <2 x float>, <2 x float>* %snd66, align 8
    %ret68 = alloca %trailv2, align 8
    %17 = tail call { i64, <2 x float> } @subtrailv2(i64 %fst65, <2 x float> %snd67)
    %box69 = bitcast %trailv2* %ret68 to { i64, <2 x float> }*
    store { i64, <2 x float> } %17, { i64, <2 x float> }* %box69, align 8
    ret i32 0
  }
