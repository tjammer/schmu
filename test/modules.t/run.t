Simplest module with 1 type and 1 nonpolymorphic function
  ...
  @none = global %prelude.option_float zeroinitializer, align 16
  @0 = private unnamed_addr global { i64, i64, i64, [4 x i8] } { i64 4, i64 3, i64 3, [4 x i8] c"%i\0A\00" }
  
  declare void @printf(i8* %0, i64 %1)
  
  define i64 @schmu___prelude.optiong.i__poly_func_classify_prelude.optionf.i(%prelude.option_float* %thing) {
  entry:
  ...
  define i64 @schmu___prelude.optiong.i__poly_func_classify_prelude.optioni.i(%prelude.option_int* %thing) {
  entry:
  ...
  entry:
    ...
    %0 = call i64 @schmu___prelude.optiong.i__poly_func_classify_prelude.optioni.i(%prelude.option_int* %option)
    ...
    %1 = call i64 @schmu___prelude.optiong.i__poly_func_classify_prelude.optionf.i(%prelude.option_float* %option2)
    call void @printf(i8* getelementptr inbounds ({ i64, i64, i64, [4 x i8] }, { i64, i64, i64, [4 x i8] }* @0, i64 0, i32 3, i64 0), i64 %1)
    store i32 1, i32* getelementptr inbounds (%prelude.option_float, %prelude.option_float* @none, i32 0, i32 0), align 4
    %str5 = alloca i8*, align 8
    store i8* bitcast ({ i64, i64, i64, [4 x i8] }* @0 to i8*), i8** %str5, align 8
    %2 = call i64 @schmu___prelude.optiong.i__poly_func_classify_prelude.optionf.i(%prelude.option_float* @none)
  ...
  entry:
    ...
    call void @schmu___agg.u.u__prelude_array-iter_aii.u.u(i64* %0, %closure* %clstmp)
    ret i64 0
  }
