Test simple setting of mutable variables
  ...
  entry:
    ...
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp, i64 14), !dbg !35
    ...
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp1, i64 %0), !dbg !37
    ...
    call void @__copy_2al2_(ptr @schmu_b__3)
...
Check aliasing
  ...
  entry:
    ...
    %envptr = getelementptr inbounds %closure, ptr %clstmp, i32 0, i32 1
    store ptr null, ptr %envptr, align 8
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp, i64 1), !dbg !34
    %clstmp1 = alloca %closure, align 8
    store ptr @__fmt_int_upc_lru_u_rupc_lru_u__, ptr %clstmp1, align 8
    %envptr3 = getelementptr inbounds %closure, ptr %clstmp1, i32 0, i32 1
    store ptr null, ptr %envptr3, align 8
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp1, i64 0), !dbg !35
    ...
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp4, i64 %3), !dbg !36
    ret void
  }
  ...
  entry:
    ...
    %envptr = getelementptr inbounds %closure, ptr %clstmp, i32 0, i32 1
    store ptr null, ptr %envptr, align 8
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp, i64 1), !dbg !38
    %clstmp1 = alloca %closure, align 8
    store ptr @__fmt_int_upc_lru_u_rupc_lru_u__, ptr %clstmp1, align 8
    %envptr3 = getelementptr inbounds %closure, ptr %clstmp1, i32 0, i32 1
    store ptr null, ptr %envptr3, align 8
    %0 = load i64, ptr @schmu_f, align 8
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp1, i64 %0), !dbg !39
    %clstmp4 = alloca %closure, align 8
    store ptr @__fmt_int_upc_lru_u_rupc_lru_u__, ptr %clstmp4, align 8
    %envptr6 = getelementptr inbounds %closure, ptr %clstmp4, i32 0, i32 1
    store ptr null, ptr %envptr6, align 8
    %1 = load i64, ptr @schmu_snd, align 8
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp4, i64 %1), !dbg !40
...
Const let
  ...
  entry:
    ...
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp, i64 %9), !dbg !34
    %clstmp1 = alloca %closure, align 8
    store ptr @__fmt_int_upc_lru_u_rupc_lru_u__, ptr %clstmp1, align 8
    %envptr3 = getelementptr inbounds %closure, ptr %clstmp1, i32 0, i32 1
    store ptr null, ptr %envptr3, align 8
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp1, i64 %6), !dbg !35
  ...
  entry:
    ...
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp, i64 %7), !dbg !37
    %clstmp1 = alloca %closure, align 8
    store ptr @__fmt_int_upc_lru_u_rupc_lru_u__, ptr %clstmp1, align 8
    %envptr3 = getelementptr inbounds %closure, ptr %clstmp1, i32 0, i32 1
    store ptr null, ptr %envptr3, align 8
    %8 = load i64, ptr @schmu_const, align 8
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp1, i64 %8), !dbg !38
    call void @schmu_in_fun(), !dbg !39
    call void @__free_al_(ptr @schmu_v)
    ret i64 0
  }
...
Copies, but with ref-counted arrays
  ...
  entry:
    ...
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp, i64 %1), !dbg !41
    ret void
  }
...
Arrays in records
  ...
  entry:
    ...
    %2 = getelementptr i8, ptr %1, i64 16
    %3 = load i64, ptr %2, align 8
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp, i64 %3), !dbg !37
    ret void
  }
...
Nested arrays
  ...
  define linkonce_odr void @__fun_fmt_stdout3_Cupc_lru_u_lrupc_lru_u2_upc_lru_u_lrupc_lru_u2_ll_(ptr noalias %0, ptr %fmter, i64 %i, ptr %1) !dbg !41 {
  entry:
  ...
  else10:                                           ; preds = %else
    tail call void @__fmt_stdout_impl_fmt_fail_missing_rupc_lru_u__(ptr %0), !dbg !46
  ...
  entry:
    ...
    %6 = getelementptr i8, ptr %5, i64 16
    %7 = load i64, ptr %6, align 8
    call void @__fmt_stdout_print2_upc_lru_u_lrupc_lru_u2_lupc_lru_u_lrupc_lru_u2_l_(ptr @0, ptr %clstmp, i64 %3, ptr %clstmp1, i64 %7), !dbg !53
    ret void
  }
  ...
  !20 = distinct !DISubprogram(name: "_fmt_int", linkageName: "__fmt_int_upc_lru_u_rupc_lru_u__", scope: !8, file: !8, line: 85, type: !4, scopeLine: 85, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  !21 = !DILocation(line: 86, column: 2, scope: !20)
  !22 = distinct !DISubprogram(name: "_fmt_stdout_impl_fmt_fail_missing", linkageName: "__fmt_stdout_impl_fmt_fail_missing_rupc_lru_u__", scope: !8, file: !8, line: 130, type: !4, scopeLine: 130, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  !23 = !DILocation(line: 131, column: 6, scope: !22)
  !24 = !DILocation(line: 131, column: 17, scope: !22)
  !25 = !DILocation(line: 132, column: 9, scope: !22)
  !26 = distinct !DISubprogram(name: "_fmt_stdout_impl_fmt_fail_too_many", linkageName: "__fmt_stdout_impl_fmt_fail_too_many_ru_", scope: !8, file: !8, line: 136, type: !4, scopeLine: 136, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  !27 = !DILocation(line: 137, column: 6, scope: !26)
  !28 = !DILocation(line: 137, column: 17, scope: !26)
  !29 = !DILocation(line: 138, column: 9, scope: !26)
  !30 = distinct !DISubprogram(name: "_fmt_stdout_print2", linkageName: "__fmt_stdout_print2_upc_lru_u_lrupc_lru_u2_lupc_lru_u_lrupc_lru_u2_l_", scope: !8, file: !8, line: 227, type: !4, scopeLine: 227, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  !31 = !DILocation(line: 228, column: 22, scope: !30)
  !32 = !DILocation(line: 235, column: 7, scope: !30)
  !33 = !DILocation(line: 235, column: 21, scope: !30)
  !34 = !DILocation(line: 236, column: 11, scope: !30)
  !35 = distinct !DISubprogram(name: "_fmt_str", linkageName: "__fmt_str_upc_lru_u_rupc_lru_u__", scope: !8, file: !8, line: 89, type: !4, scopeLine: 89, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  !36 = !DILocation(line: 90, column: 22, scope: !35)
  !37 = !DILocation(line: 90, column: 40, scope: !35)
  !38 = !DILocation(line: 90, column: 2, scope: !35)
  !39 = distinct !DISubprogram(name: "__fun_fmt2", linkageName: "__fun_fmt2", scope: !8, file: !8, line: 77, type: !4, scopeLine: 77, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  !40 = !DILocation(line: 78, column: 6, scope: !39)
  !41 = distinct !DISubprogram(name: "__fun_fmt_stdout3", linkageName: "__fun_fmt_stdout3_Cupc_lru_u_lrupc_lru_u2_upc_lru_u_lrupc_lru_u2_ll_", scope: !8, file: !8, line: 228, type: !4, scopeLine: 228, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  !42 = !DILocation(line: 230, column: 8, scope: !41)
  !43 = !DILocation(line: 230, column: 11, scope: !41)
  !44 = !DILocation(line: 231, column: 8, scope: !41)
  !45 = !DILocation(line: 231, column: 11, scope: !41)
  !46 = !DILocation(line: 232, column: 11, scope: !41)
  !47 = distinct !DISubprogram(name: "_fmt_aux", linkageName: "fmt_aux", scope: !8, file: !8, line: 60, type: !4, scopeLine: 60, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  !48 = !DILocation(line: 63, column: 21, scope: !47)
  !49 = !DILocation(line: 64, column: 10, scope: !47)
  !50 = !DILocation(line: 67, column: 11, scope: !47)
...
Modify in function
  ...
  define linkonce_odr void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %fmt, i64 %value) !dbg !25 {
  entry:
    %ret = alloca %fmt.formatter.tu_, align 8
  ...
  entry:
    ...
    %sub = sub i64 %_fmt_length2, %i
    %sub3 = sub i64 %sub, 1
    tail call void @__array_fixed_swap_items_A64c__(ptr %_fmt_arr1, i64 %i, i64 %sub3), !dbg !30
    ret void
  }
  ...
  entry:
    tail call void @__array_push_al_l_(ptr %a, i64 20), !dbg !37
    ret void
  }
  ...
  entry:
    ...
    %4 = load i64, ptr %3, align 8
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp1, i64 %4), !dbg !43
  ...
  !25 = distinct !DISubprogram(name: "_fmt_stdout_println", linkageName: "__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_", scope: !11, file: !11, line: 192, type: !4, scopeLine: 192, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  ...
  !29 = distinct !DISubprogram(name: "__fun_fmt2", linkageName: "__fun_fmt2", scope: !11, file: !11, line: 77, type: !4, scopeLine: 77, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  !30 = !DILocation(line: 78, column: 6, scope: !29)
  !31 = distinct !DISubprogram(name: "_fmt_aux", linkageName: "fmt_aux", scope: !11, file: !11, line: 60, type: !4, scopeLine: 60, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition | DISPFlagOptimized, unit: !0, retainedNodes: !5)
  !32 = !DILocation(line: 63, column: 21, scope: !31)
  !33 = !DILocation(line: 64, column: 10, scope: !31)
  !34 = !DILocation(line: 67, column: 11, scope: !31)
...
Refcounts for members in arrays, records and variants
  ...
  entry:
    ...
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp, i64 %8), !dbg !34
    ...
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp4, i64 %17), !dbg !35
  ...
  then:                                             ; preds = %entry
    ...
    call void @__fmt_stdout_println_upc_lru_u_lrupc_lru_u2_l_(ptr %clstmp7, i64 %24), !dbg !37
    br label %ifcont
