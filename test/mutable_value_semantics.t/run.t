...
Use mutable values as ptrs to C code
  ...
  @schmu_foo = global %l_ zeroinitializer, align 8
  
  declare void @mutate_int(i64* noalias %0)
  
  declare void @mutate_foo(%l_* noalias %0)
  
  define i64 @main(i64 %arg) {
  entry:
    tail call void @mutate_int(i64* @schmu_i)
    tail call void @mutate_foo(%l_* @schmu_foo)
    ret i64 0
  }
...
Check aliasing
  ...
  define i64 @main(i64 %arg) {
  entry:
    store i64 0, i64* getelementptr inbounds (%l_, %l_* @schmu_f, i32 0, i32 0), align 8
    tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast (%l_* @schmu_fst to i8*), i8* bitcast (%l_* @schmu_f to i8*), i64 8, i1 false)
    tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast (%l_* @schmu_snd to i8*), i8* bitcast (%l_* @schmu_fst to i8*), i64 8, i1 false)
    store i64 1, i64* getelementptr inbounds (%l_, %l_* @schmu_fst, i32 0, i32 0), align 8
    tail call void (i8*, ...) @printf(i8* getelementptr (i8, i8* bitcast ({ i64, i64, [5 x i8] }* @0 to i8*), i64 16), i64 1)
    %0 = load i64, i64* getelementptr inbounds (%l_, %l_* @schmu_f, i32 0, i32 0), align 8
    tail call void (i8*, ...) @printf(i8* getelementptr (i8, i8* bitcast ({ i64, i64, [5 x i8] }* @0 to i8*), i64 16), i64 %0)
    %1 = load i64, i64* getelementptr inbounds (%l_, %l_* @schmu_snd, i32 0, i32 0), align 8
    tail call void (i8*, ...) @printf(i8* getelementptr (i8, i8* bitcast ({ i64, i64, [5 x i8] }* @0 to i8*), i64 16), i64 %1)
...
Copies, but with ref-counted arrays
  ...
  define linkonce_odr void @__schmu_print_0th_al_ru_(i64* %a) {
  entry:
  ...
  entry:
    ...
    call void @__schmu_print_0th_al_ru_(i64* %12)
    ...
    call void @__schmu_print_0th_al_ru_(i64* %16)
    %17 = load i64*, i64** %4, align 8
    call void @__schmu_print_0th_al_ru_(i64* %17)
    %18 = load i64*, i64** %7, align 8
    call void @__schmu_print_0th_al_ru_(i64* %18)
    %19 = load i64*, i64** %4, align 8
    call void @__schmu_print_0th_al_ru_(i64* %19)
  ...
  entry:
    ...
    tail call void @__schmu_print_0th_al_ru_(i64* %7)
    ...
    tail call void @__schmu_print_0th_al_ru_(i64* %11)
    %12 = load i64*, i64** @schmu_b, align 8
    tail call void @__schmu_print_0th_al_ru_(i64* %12)
    %13 = load i64*, i64** @schmu_c, align 8
    tail call void @__schmu_print_0th_al_ru_(i64* %13)
    %14 = load i64*, i64** @schmu_d, align 8
    tail call void @__schmu_print_0th_al_ru_(i64* %14)
    tail call void @schmu_in_fun()
...
Arrays in records
  ...
  @schmu_a = global %al2_ zeroinitializer, align 8
  @schmu_b = global %al2_ zeroinitializer, align 8
  @0 = private unnamed_addr constant { i64, i64, [5 x i8] } { i64 4, i64 4, [5 x i8] c"%li\0A\00" }
  @1 = private unnamed_addr constant { i64, i64, [7 x i8] } { i64 6, i64 6, [7 x i8] c"in fun\00" }
  ...
  entry:
    ...
    %4 = alloca %al2_, align 8
    %5 = bitcast %al2_* %4 to i8*
    %6 = bitcast %al2_* %0 to i8*
    call void @llvm.memcpy.p0i8.p0i8.i64(i8* %5, i8* %6, i64 8, i1 false)
    call void @__copy_al2_(%al2_* %4)
    store i64 12, i64* %data, align 8
    %unbox = bitcast %al2_* %0 to i64*
    %unbox2 = load i64, i64* %unbox, align 8
    call void @schmu_print_thing(i64 %unbox2)
    %unbox3 = bitcast %al2_* %4 to i64*
    %unbox4 = load i64, i64* %unbox3, align 8
    call void @schmu_print_thing(i64 %unbox4)
    call void @__free_al2_(%al2_* %4)
    call void @__free_al2_(%al2_* %0)
    ret void
  }
  ...
  define linkonce_odr void @__copy_al2_(%al2_* %0) {
  entry:
  ...
  entry:
    ...
    %data = bitcast i8* %2 to i64*
    store i64 10, i64* %data, align 8
    store i64* %1, i64** getelementptr inbounds (%al2_, %al2_* @schmu_a, i32 0, i32 0), align 8
    tail call void @llvm.memcpy.p0i8.p0i8.i64(i8* bitcast (%al2_* @schmu_b to i8*), i8* bitcast (%al2_* @schmu_a to i8*), i64 8, i1 false)
    tail call void @__copy_al2_(%al2_* @schmu_b)
    %3 = load i64*, i64** getelementptr inbounds (%al2_, %al2_* @schmu_a, i32 0, i32 0), align 8
    %4 = bitcast i64* %3 to i8*
    %5 = getelementptr i8, i8* %4, i64 16
    %data1 = bitcast i8* %5 to i64*
    store i64 12, i64* %data1, align 8
    %unbox = load i64, i64* bitcast (%al2_* @schmu_a to i64*), align 8
    tail call void @schmu_print_thing(i64 %unbox)
    %unbox2 = load i64, i64* bitcast (%al2_* @schmu_b to i64*), align 8
    tail call void @schmu_print_thing(i64 %unbox2)
    tail call void @string_print(i8* bitcast ({ i64, i64, [7 x i8] }* @1 to i8*))
    tail call void @schmu_in_fun()
    tail call void @__free_al2_(%al2_* @schmu_b)
    tail call void @__free_al2_(%al2_* @schmu_a)
    ret i64 0
  }
...
Nested arrays
  ...
  define linkonce_odr void @__schmu_prnt_2al2_ru_(i64** %a) {
  entry:
    %0 = bitcast i64** %a to i8*
    %1 = getelementptr i8, i8* %0, i64 16
    %data = bitcast i8* %1 to i64**
  ...
  entry:
    ...
    tail call void @__schmu_prnt_2al2_ru_(i64** %16)
    %17 = load i64**, i64*** @schmu_b, align 8
    tail call void @__schmu_prnt_2al2_ru_(i64** %17)
...
Modify in function
  ...
  define void @schmu_modify(%l_* noalias %r) {
  entry:
    %0 = bitcast %l_* %r to i64*
  ...
  define i64 @main(i64 %arg) {
  entry:
    store i64 20, i64* getelementptr inbounds (%l_, %l_* @schmu_a, i32 0, i32 0), align 8
    tail call void @schmu_modify(%l_* @schmu_a)
...
Make sure variable ids are correctly propagated
  ...
  define linkonce_odr i64* @__schmu_f1_al_lral2_(i64* %acc, i64 %v) {
  entry:
    %0 = alloca i64*, align 8
    ...
    call void @__array_push_al_lru_(i64** %0, i64 %v)
    %4 = load i64*, i64** %0, align 8
    ret i64* %4
  }
  ...
  entry:
    ...
    %4 = tail call i64* @__schmu_f1_al_lral2_(i64* %3, i64 0)
...
Free array params correctly if they are returned
  ...
  define linkonce_odr i64* @__schmu_pass_al_ral2_(i64* %x) {
  entry:
    ret i64* %x
  }
  ...
  entry:
    ...
    %data = bitcast i8* %2 to i64*
    store i64 10, i64* %data, align 8
    %3 = tail call i64* @__schmu_pass_al_ral2_(i64* %1)
    ret i64* %3
  }
...
Refcounts for members in arrays, records and variants
  ...
  @schmu_a = global i64* null, align 8
  @schmu_r = global %al2_ zeroinitializer, align 8
  @schmu_r__2 = global i64** null, align 8
  @schmu_r__3 = global %val2_ zeroinitializer, align 8
  @0 = private unnamed_addr constant { i64, i64, [5 x i8] } { i64 4, i64 4, [5 x i8] c"%li\0A\00" }
  ...
  entry:
    ...
    store i64* %5, i64** getelementptr inbounds (%al2_, %al2_* @schmu_r, i32 0, i32 0), align 8
    %6 = load i64*, i64** @schmu_a, align 8
    %7 = bitcast i64* %6 to i8*
    %8 = getelementptr i8, i8* %7, i64 16
    %data1 = bitcast i8* %8 to i64*
    store i64 20, i64* %data1, align 8
    %9 = load i64*, i64** getelementptr inbounds (%al2_, %al2_* @schmu_r, i32 0, i32 0), align 8
    %10 = bitcast i64* %9 to i8*
    %11 = getelementptr i8, i8* %10, i64 16
    ...
    store i32 0, i32* getelementptr inbounds (%val2_, %val2_* @schmu_r__3, i32 0, i32 0), align 4
    ...
    store i64* %29, i64** getelementptr inbounds (%val2_, %val2_* @schmu_r__3, i32 0, i32 1), align 8
    ...
    %index = load i32, i32* getelementptr inbounds (%val2_, %val2_* @schmu_r__3, i32 0, i32 0), align 4
    %eq = icmp eq i32 %index, 0
    br i1 %eq, label %then, label %else
  
  then:                                             ; preds = %entry
    %33 = load i64*, i64** getelementptr inbounds (%val2_, %val2_* @schmu_r__3, i32 0, i32 1), align 8
  ...
  ifcont:                                           ; preds = %else, %then
    call void @__free_val2_(%val2_* @schmu_r__3)
    call void @__free_2al2_(i64*** @schmu_r__2)
    call void @__free_al2_(%al2_* @schmu_r)
